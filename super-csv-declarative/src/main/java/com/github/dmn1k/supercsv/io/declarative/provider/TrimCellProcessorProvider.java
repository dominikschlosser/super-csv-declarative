...
public class TrimCellProcessorProvider implements
        DeclarativeCellProcessorProvider<com.github.dmn1k.supercsv.io.declarative.annotation.Trim> {

    /**
     * {@inheritDoc}
     */
    @Override
    public CellProcessorFactory create(ProcessingMetadata<com.github.dmn1k.supercsv.io.declarative.annotation.Trim> metadata) {
     ...
     */
    @Override
    public Class<com.github.dmn1k.supercsv.io.declarative.annotation.Trim> getType() {
        return com.github.dmn1k.supercsv.io.declarative.annotation.Trim.class;
    }
