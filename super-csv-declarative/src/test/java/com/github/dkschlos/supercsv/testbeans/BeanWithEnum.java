...
public class BeanWithEnum {
    ...
    public BeanWithEnum(TestEnum testEnum) {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 53 * hash + (this.testEnum != null ? this.testEnum.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BeanWithEnum other = (BeanWithEnum) obj;
        if (this.testEnum != other.testEnum) {
            return false;
        }
        return true;
    }
