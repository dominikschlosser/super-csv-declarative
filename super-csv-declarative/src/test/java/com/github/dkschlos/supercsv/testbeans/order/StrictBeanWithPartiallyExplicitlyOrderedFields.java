...
public class StrictBeanWithPartiallyExplicitlyOrderedFields {
    ...
    public StrictBeanWithPartiallyExplicitlyOrderedFields() {
    }

    public StrictBeanWithPartiallyExplicitlyOrderedFields(String name, String lastName, int age, double weight) {
        this.name = name;
    ...
    public boolean equals(Object obj) {
        ...
        StrictBeanWithPartiallyExplicitlyOrderedFields other = (StrictBeanWithPartiallyExplicitlyOrderedFields) obj;
        if (age != other.age) {
            return false;
        }
        if (lastName == null) {
    ...
    public String toString() {
        return "StrictBeanWithPartiallyExplicitlyOrderedFields [name=" + name + ", lastName=" + lastName + ", age=" + age
                + ", weight=" + weight + "]";
    }
